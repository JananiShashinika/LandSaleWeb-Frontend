# LandSaleWeb Frontend

This is the frontend for the LandSaleWeb project, which is a web application for buying and selling land. This repository contains the user interface built with modern web technologies.
