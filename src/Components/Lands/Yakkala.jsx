...
export default function Yakkala() {
  ...
  const toggleTab = (index) => {
   ...
   return (  
    <div className="p-20px" style={{background:"lavender"}}>
 ...
 <div className="grid">
  ...
  < div className='details'>
   ...
   <br/><h4>upto Rs.80,000 per perch... </h4>
      </div>
  <p align="justify-content-center"> <h5>
             ...
             <br></br>
             <div className="container2 p-20px" style={{background:"lightgrey"}}>
      ...
      <div className="content-tabs">
        ...
        >
          ...
          <hr />
          <h5>Images of the land for more..</h5>
    ...
    <MDBCol lg={4} className='mb-4 mb-lg-0'>
      <img
        ...
        >
          <h4 >Land Location</h4>
          <hr />
          <h5> Land location of Yakkala - Green Paradise </h5>

         < iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d253304.97848882867!2d80.05638599395752!3d7.253325762423891!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae316b5e62efe8b%3A0xd80dc714f497425c!2sKegalle%20Main%20Bus%20Stand!5e0!3m2!1sen!2slk!4v1681426312454!5m2!1sen!2slk"
