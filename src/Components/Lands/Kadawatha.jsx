...
export default function Kadawatha() {
 ...
 < MDBRow> 
      ...
      <img  
          ...
          <h2><span className='text-warning' >Kadawatha </span><br/></h2>
   <h3> <span style={{color:'green'}}>Millenium Lands</span> </h3>
   <br/><h4>Rs.300,000-Rs.500,000 per perch... </h4>
   <br/><h5>Best for Residence & Investments</h5>
      </div>
      </MDBCol>
    </MDBRow>
         </div>
      ...
      <div className="content-tabs">
        ...
        >
          ...
          <hr />
          <h5>This land is located near the highway entrance of Kadawatha, 5 minutes for the place </h5>
           
         < MDBRow> 
      <MDBCol lg={4} className='mb-4 mb-lg-0'>
      <img
          src="/img/kadawatha/1.jpg"
          className="shadow-1-strong rounded mb-4"
          alt="1" 
          height={400}
          width={500}/>
    ...
    <MDBCol lg={4} className='mb-4 mb-lg-0'>
      <img
        ...
        >
          <h4 >Land Location</h4>
          <hr />
          <h5>Land location of Kadawatha - Millenium Lands  </h5>
