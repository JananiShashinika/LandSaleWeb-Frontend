...
export default function Aboutus() {
  return (
    <Card className="bg-dark text-black h-10 " >
      ...
      <Card.ImgOverlay>
        <Card.Title><h1 className="text-align:center">About Us.. </h1></Card.Title>
        <br></br>
        <Card.Text>
        <h3 className="center" style={{color:"yellow"}}>The Best place to invest..</h3>
        </Card.Text>
        
        <div className="black center">
        <div style={{color: "white", fontSize:"20px" , width:"95%",height:"600px"}}> We have been in business for past 32 years and we are specialized in providing
